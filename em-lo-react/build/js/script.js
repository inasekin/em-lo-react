...
jQuery(document).ready(function() {
    ...
    if (contentmore_height > 350) {
        $('.content-more__content').css('height','300px');
        $('.content-more__more, .content-more__more a').click(function() {
            ...
            if (wrapper.hasClass('content-more__wrapper--opened')) {
                content.animate({height: '300px'},'fast','linear',function() {
...
if (iconMenu != null) {
	let delay = 500;
	let menuBody = document.querySelector(".header__navbar");
